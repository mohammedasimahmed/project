...
export default function Womens() {
  return (
   ...
   <div><img src="https://static.nike.com/a/images/f_auto/dpr_1.3,cs_srgb/w_1423,c_limit/71960002-7601-4cb7-b9d0-0334ba6a2363/women-s-shoes-clothing-accessories.png"/>

   </div>
 </div>

 <div class="summerEssential">
   <p>Summer Essentials</p>
   <h1>Dare To Leap</h1>
   <p>Move,Explore Bring your Blodest</p>
<div class="shop_btn"><button><Link to="/allShoes"> Shop </Link></button></div>
 </div>
...
<div class="trending-img">
   ...
   <div class="img1"><img src="https://images.unsplash.com/photo-1585591359088-e144e8a61170?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8bmlrZSUyMHdvbWVufGVufDB8fDB8fHww&auto=format&fit=crop&w=1000&q=60" alt="" /></div>
   <div class="img2"><img src="https://images.unsplash.com/photo-1590330297626-d7aff25a0431?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bmlrZSUyMHdvbWVufGVufDB8fDB8fHww&auto=format&fit=crop&w=1000&q=60" alt="" /></div>
 </div>
</div>    
 ...
 <div class="product-container">
     ...
     <div class="product-card">
         ...
         <div class="product-info">
             <h2 class="product-Nike">Nike</h2>
             <p class="product-short-description">about shoes..</p>
             <span class="price">$133</span><span class="actual-price">$40</span>
         </div>
     </div>
     <div class="product-card">
         <div class="product-image">
...
<div class="last">
<img src="https://media4.giphy.com/media/3o6Ztqh4JSlVqi2Z20/giphy.gif?cid=ecf05e47jwyclntj318kr056m1klqi4y2abc5ua1fwrg0sle&ep=v1_gifs_search&rid=giphy.gif&ct=g" alt="" />
</div>
